  ...
  <div className="regionals">
    ...
    <Container narrow>
      ...
      <Stack pb={10} spacing={10} align="center">
        <Stack align="left">
          <Text>
            This privacy notice for ACM ICPC at UCLA ("we," "us," or "our"),
          ...
          <List styleType="disc" paddingX="5%">
            <ListItem>
              Visit our website at https://icpc.uclaacm.com, or any website of
          ...
          <Text>
            ...
            contact us at uclaicpc@gmail.com.
          </Text>
          ...
          <Text>
            ...
            more about personal information you disclose to us below.
          </Text>
          <Text>
          ...
          <Text>
            ...
            keep your information safe below.
          </Text>
          <Text>
          ...
          <Text>
            Keep reading to learn more about what we do with any information we
            collect?{" "}
          </Text>
          ...
          <Text textAlign="center">
            ...
            provide to us. That is, we do not collect any sensitive information
            whatsoever. How do you exercise your rights? The easiest way to
            exercise your rights is by submitting a data subject access request,
            or by contacting us. We will consider and act upon any request in
            ...
            notice in full. We collect personal information that you voluntarily
          ...
          <List styleType="disc" paddingX="5%">
            ...
            <ListItem>
              ...
              not be able to use certain aspects of the
            </ListItem>
          </List>
          ...
          <Text>
            ...
            fraud prevention, and to comply with law. We currently do not
            process your information for other purposes.
          </Text>
          <Text>
            We process your personal information for a variety of reasons,
            depending on how you interact with our Services, including: to save
            or protect an individual's vital interest. We may process your
          ...
          <Text>
            ...
            contractual obligations, to protect your rights, or to fulfill the
            legitimate interests of ACM at UCLA.
          </Text>
          ...
          <List styleType="disc" paddingX="5%">
            <ListItem>
              ...
              more about withdrawing your consent by contacting us.
            </ListItem>
            <ListItem>
          ...
          <Text>
            We may process your information only if you have given us specific
          ...
          <Text>
            ...
            Google Analytics to track and analyze the use of the Services. To
          ...
          <Text>
            ...
            information. You may review, change, or terminate your information
            at any time.
          </Text>
          <Text>
          ...
          <Text>
            ...
            email us at uclaicpc@gmail.com.
          </Text>
          ...
          <Text>
            In Short: If you are a resident of Colorado, Connecticut, Utah,
            Virginia or California, you are granted specific rights regarding
          ...
          <Text>
            ...
            in the past twelve (12) months (i.e. none). <br></br>The following
            lists the broad category of the information, and whether or not we
            collect them:
          </Text>
          <OrderedList styleType="upper-alpha" wdith="90%">
            <ListItem>
              Identifiers: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Personal information as defined in the California Customer Records
              statue: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Protected classification characteristics under state or federal
              law: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Commercial information: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Biometric information: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Internet or other similar network activity: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Geolocation data: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Audio, electronic, visual themal, olfactory, or similar
              information: <strong>NO</strong>
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              Education information: <strong>NO</strong>
            </ListItem>
            <ListItem>
              Information drawn from collected personal information:{" "}
              <strong>NO</strong>
            </ListItem>
            <ListItem>
              Sensitive personal information: <strong>NO</strong>
            </ListItem>
          </OrderedList>
          <Text>
          ...
          <Text>
            ...
            Learn more about how we disclose personal information to the
          ...
          <Text>
            ...
            subject access request, by email at uclaicpc@gmail.com, or by
          ...
          <Text>
            ...
            change that information, ordelete it. To request to review, update,
